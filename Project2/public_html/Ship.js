...
//    gl.enableVertexAttribArray(this.vColor);
    ...
    this.vNormal = gl.getAttribLocation(this.shade, "vNormal");
    ...
    this.lightPosition = gl.getUniformLocation(this.shade, "lightPosition");
    this.lightColor = gl.getUniformLocation(this.shade, "lightColor");
    this.ambientFactor = gl.getUniformLocation(this.shade, "ambientFactor");
    
    // Get uniform variable locations for material properties (K)
    // At the moment, we only send one color and use it for ambient, diffuse and specular
    this.materialColor = gl.getUniformLocation(this.shade, "materialColor");
    this.materialShiny = gl.getUniformLocation(this.shade, "shiny");
    ...
    this.ambientOn = gl.getUniformLocation(this.shade, "ambientOn");
    this.diffuseOn = gl.getUniformLocation(this.shade, "diffuseOn");
    this.specularOn = gl.getUniformLocation(this.shade, "specularOn");
...
//console.log("Out");
   ...
   gl.uniformMatrix4fv(this.modelMat, false, flatten(this.shipViewMat));
